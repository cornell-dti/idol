...
const Footer: React.FC = () => (
  <div className="w-full h-[146px] fixed inset-x-0 bottom-0 md:px-[40px] lg:px-[60px] bg-stone-950 inline-flex justify-between items-center md:flex-row flex-col">
