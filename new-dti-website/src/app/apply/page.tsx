      ...
      >
        <div className="flex items-center justify-center h-full">
          <div className="flex-1 flex flex-col justify-center items-start pl-[10%]">
            <h1
              className="text-white text-8xl font-semibold uppercase"
              style={{
                lineHeight: '1.2em',
          ...
          <div className="flex-1 flex flex-col justify-center items-start pr-[10%] text-white">
            <p
              className="text-4xl"
              style={{ fontFamily: 'Inter, sans-serif', fontWeight: 'bold', marginBottom: '1rem' }}
            >
            ...
            >
              ...
              passionate applicants to apply, regardless of experience. We’d love to work with
              someone like you.
            </p>
            <button
              style={{
