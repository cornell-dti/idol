    ...
    const stages = [
        {
            ...
            content: "We’re welcoming any and all students who are looking to make a difference through tech. Applicants are not considered on a rolling basis.",
            date: '2024-03-14',
            location: 'Online Submission'
        },
        {
            title: "INFORMATION SESSION 1",
            content: "Come join us for a session to learn about DTI, our goals, and our subteams. There will be time to chat with DTI members of all roles after!",
            date: '2024-03-18',
        ...
        <div className="flex flex-col items-center justify-center w-screen h-fit bg-black">
            ...
            >
                <div
                    ...
                    style={{ backgroundColor: '#A52424', borderTopLeftRadius: '25px', borderTopRightRadius: '25px' }}
                >
                ...
                <div className="relative bg-white p-30 text-black rounded-b-lg" style={{ borderBottomLeftRadius: '25px', borderBottomRightRadius: '25px' }}>
                    <div className="absolute left-20 top-0 bottom-0 w-3" style={{ backgroundColor: '#A52424' }}></div>
                        ...
                        return (
                            <div key={index} className="flex mt-8 first:mt-0 ml-16">
                                <div className="relative flex-shrink-0">
                                    <img src={`/apply_icons/${isCurrentStage ? 'selected-timeline-event' : 'unselected-timeline-event'}.png`} alt="" className="w-16 h-16" />
                                ...
                                <div className="ml-8">
                                    ...
                                    <div className="flex items-center mt-2 ml-4">
                                        <img
                                            src={isCurrentStage ? '/apply_icons/timeline-location_select.png' : '/apply_icons/timeline-location.png'}
                                            alt="Location"
                                            className="w-6 h-6"
                                        />
                                        <span className={`mx-2 ${isCurrentStage ? 'text-black' : 'text-gray-400'}`}>{stage.location}</span>
                                        <img
                                            src={isCurrentStage ? '/apply_icons/timeline-calendar_select.png' : '/apply_icons/timeline-calendar.png'}
                                            alt="Calendar"
                                            className="w-6 h-6"
                                        />
