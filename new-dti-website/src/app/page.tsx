        ...
        <div className="hero-section" style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', paddingLeft: '20%' }}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', marginRight: '50px' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center' }}>
                    <Icons defaultClass="dti" altText="DTI" dataIndex={0} onClick={() => handleIconClick(0)} />
                    <Icons defaultClass="family" altText="Family" dataIndex={1} onClick={() => handleIconClick(1)} />
                    <Icons defaultClass="collaboration" altText="Collaboration" dataIndex={2} onClick={() => handleIconClick(2)} />
                    <Icons defaultClass="events" altText="Events" dataIndex={3} onClick={() => handleIconClick(3)} />
                    <Icons defaultClass="initiatives" altText="Initiatives" dataIndex={4} onClick={() => handleIconClick(4)} />
                </div>
            </div>
