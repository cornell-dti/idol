...
export default function TabsPage() {
  return (
    <PageLayout title="Tabs">
      ...
      >
        <div className="[&>div>div]:p-0 [&>div]:gap-8">
          <Tabs
            tabs={[
              {
                label: 'Light theme',
                content: (
                  <div
                    className="bg-white flex items-center justify-center flex-col gap-2 w-fill h-48 p-8 rounded-lg"
                    tabIndex={0}
                  >
              ...
              },
              {
                label: 'Dark theme',
                content: (
                  <div className="bg-black flex items-center justify-center flex-col gap-2 w-fill h-48 p-8 rounded-lg">
              ...
              },
              {
                label: 'Hotdog theme',
                content: (
                  <div className="bg-[#E93323] flex items-center justify-center flex-col gap-2 w-fill h-48 p-8 rounded-lg">
