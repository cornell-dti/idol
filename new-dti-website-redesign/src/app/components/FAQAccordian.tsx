  ...
  return (
    <Accordion.Root type="single" collapsible>
      <Accordion.Item value="item-1" className="group w-[880px] border border-border-1">
        <Accordion.Header>
          <Accordion.Trigger className="w-full focus-visible:outline focus-visible:outline-[2px] focus-visible:outline-offset-[3px] focus-visible:outline-[var(--foreground-1)]">
            <div className=" p-[32px] group-data-[state=open]:pb-[16px] bg-background-1 group-data-[state=open]:bg-background-2 hover:bg-background-2 group-data-[state=open]:hover:bg-background-3">
