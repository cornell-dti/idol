...
const Banner = ({ label, type }: Props): ReactNode => {
  ...
  return (
    <div className="p-4 md:p-6 sticky top-20 bg-background-2 border-t border-b border-border-1 flex items-center justify-center z-10 w-full items-center text-center">
      <p>{label}</p>
    </div>
  );
};
