        ...
        <PageSection className="initiatives-main-section">
          <Container>
            <Row className="initiative-row align-items-center justify-content-center">
              <Col sm="12" md="7" className="initiative-row-img order-md-2 order-sm-1">
                <img
              ...
              <Col
                ...
                md="5"
              >
                <div className="initiative-row-content-header">Ready, Set, Make!</div>
                ...
                <p className="initiative-row-content">
                  ...
                  students! We invite students in the local community to Cornell and how they can
                  use design thinking to solve problems that they encounter. Their energy and
                  creativity was contagious, and team members and kids alike were building
                  incredible prototypes out of cardboard and craft supplies! DTI partnered with
                  Makerspace to give an introduction to 3D printing using Tinkercad.
                </p>
                <Button
                  variant="secondary"
            ...
            <Row className="initiative-row justify-content-center align-items-center">
              <Col sm="12" md="7" className="initiative-row-img order-md-1 order-sm-1">
                <img
                  className="initiative-row-image"
              ...
              >
                <div className="initiative-row-content-header">DTI Blueprint</div>
                <div className="initiative-row-content-subheader">Fostering Mentorship.</div>
                <p className="initiative-row-content">
                  ...
                  members gave workshops on concepts like user research, product ideation, and
                  minimum viable products. Students formed groups and brainstormed a problem to
                  solve on campus and came up with a testable solution.
                </p>
              </Col>
            </Row>
            <Row className="initiative-row align-items-center justify-content-center">
              ...
              <Col
                ...
                className="initiative-row-content-container order-md-1 order-sm-2"
              >
                <div className="initiative-row-content-header">Events &amp; Workshops</div>
                <div className="initiative-row-content-subheader">Our presence on campus.</div>
                <p className="initiative-row-content">
                  We are constantly trying to find ways to expand beyond our team and help the
                  community through holding workshops and events. In the past, we have held
                  workshops on UX Research, building a website portfolio, and more!
                </p>
                <Button
                  variant="secondary"
                  className="social-button"
